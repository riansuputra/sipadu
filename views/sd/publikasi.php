                        ...
                        <div class="col-sm-12">
                            ...
                            <form method="get">
                                <div class="row">
                                    ...
                                    <input type="hidden" name="page" value="publikasi-sd">
                                    ...
                                    <div class="col-auto ms-auto">
                                        ...
                                        <a href="<?= url('?page=publikasi-sd') ?>" class="btn btn-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <?php if ($isFiltered): ?>
                            <div class="alert alert-info d-flex align-items-center justify-content-between" role="alert">
                                ...
                                <a href="<?= url('?page=publikasi-sd') ?>" class="btn btn-sm btn-info">
                                    Reset Filter
                                </a>
                            </div>
                        <?php else: ?>
                        ...
                        <div class="table-responsive">
                            <table id="publikasiTimSdTable" class="table table-vcenter table-selectable table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th class="w-1">No</th>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const table = new DataTable('#publikasiTimSdTable', {
            pageLength: 10,
            ...
            layout: {
                topStart: {
                    ...
                    div: {
                        html: `
                        <a href="<?= url('?page=publikasi-sd') ?>" class="btn btn-primary btn-sm btn-6 btn-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-refresh">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                <path d="M20 11a8.1 8.1 0 0 0 -15.5 -2m-.5 -4v4h4"></path>
                                <path d="M4 13a8.1 8.1 0 0 0 15.5 2m.5 4v-4h-4"></path>
