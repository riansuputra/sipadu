    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Dashboard DIP</h2>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row row-deck row-cards ">
                ...
                <div class="row row-cards">
                        ...
                        <div class="card bg-cyan text-white">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="text-white h4 m-0">Total DIP</div>
                                </div>
                                <div class="h1 m-0"><?= htmlspecialchars($dip['total_dip'] ?? '-') ?></div>
                                <div class="d-flex">
                                    <div></div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card bg-teal text-white">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="text-white h4 m-0">DIP Tahun Ini</div>
                                </div>
                                <div class="h1 m-0"><?= htmlspecialchars($dip['dip_tahun_ini'] ?? '-') ?></div>
                                <div class="d-flex">
                                    <div></div>
                                    <a href="<?= url('?page=tambah-dip') ?>" class="btn btn-light btn-sm ms-auto text-dark">Tambah DIP +</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <div class="card bg-lime text-white">
                            ...
                            <div class="card-body">
                                ...
                                <div class="h1 m-0"><?= htmlspecialchars($dip['total_file'] ?? '-') ?></div>
                                <div class="d-flex">
                                    <div></div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card bg-green text-white">
                            ...
                            <div class="card-body">
                                ...
                                <div class="h1 m-0"><?= htmlspecialchars($dip['total_size'] ?? '-') ?></div>
                                <div class="d-flex">
                                    <div></div>
                                    <a href="<?= url('?page=tambah-dip') ?>" class="">&nbsp</a>
                                </div>
            ...
            <div class="col-lg-6 col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h3 class="card-title">Komposisi DIP</h3>
                            <div class="ms-auto mb-3 text-muted">
                                <?= date('Y') ?>
                            </div>
                        </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const labels = <?= json_encode($jenis_informasi_chart['labels']) ?>;
        const data = <?= json_encode($jenis_informasi_chart['data']) ?>;
