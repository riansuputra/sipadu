    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Dashboard Publikasi</h2>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card bg-cyan text-white">
                            ...
                            <div class="card-body">
                                ...
                                <div class="h1 m-0"><?= htmlspecialchars($publikasi['total_publikasi'] ?? '-') ?></div>
                                <div class="d-flex">
                                    <div></div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card bg-teal text-white">
                            ...
                            <div class="card-body">
                                ...
                                <div class="h1 m-0"><?= htmlspecialchars($publikasi['terpublikasi'] ?? '-') ?></div>
                                <div class="d-flex">
                                    <div></div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card bg-lime text-white">
                            ...
                            <div class="card-body">
                                ...
                                <div class="h1 m-0"><?= htmlspecialchars($publikasi['total_file'] ?? '-') ?></div>
                                <div class="d-flex">
                                    <div></div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card bg-green text-white">
                            ...
                            <div class="card-body">
                                ...
                                <div class="h1 m-0"><?= htmlspecialchars($publikasi['size_publikasi'] ?? '-') ?></div>
                                <div class="d-flex">
                                    <div></div>
                                    <a href="<?= url('?page=tambah-dip') ?>" class="">&nbsp</a>
                                </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        const labels = <?= json_encode($publikasi['publikasi_chart']['labels']) ?>;
        const data = <?= json_encode($publikasi['publikasi_chart']['data']) ?>;
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const labels = <?= json_encode($publikasi['publikasi_pokja_chart']['labels']) ?>;
        const data = <?= json_encode($publikasi['publikasi_pokja_chart']['data']) ?>;
