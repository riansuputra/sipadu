    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Edit Jenis Peraturan</h2>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-xl">
        <div class="row row-cards ">
            ...
            <div class="col-sm-12 col-lg-6">
                <form class="card" method="POST" action="<?= url('?page=jenis-peraturan-update&id=' .  $data['id']) ?>" enctype="multipart/form-data">
                    <div class="card-header">
                        <h3 class="card-title">Form Edit Jenis Peraturan</h3>
                    </div>
                    <div class="card-body">
                        <div class="form-fieldset">
                            <div class="mb-3">
                                <label class="form-label required">Singkatan Jenis :</label>
                                <div class="col">
                                    <input
                                        type="text"
                                        name="kode"
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const table = new DataTable('#jenisPeraturanTable', {
            pageLength: 10,
