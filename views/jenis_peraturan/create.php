                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row w-full">
                            <div class="col">
                                <h3 class="card-title mb-0">Tabel Jenis Peraturan</h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="jenisPeraturanTable" class="table table-vcenter table-selectable table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th class="w-1">No</th>
                                        <th class="w-1">Singkatan Jenis</th>
