...
<div class="page-header d-print-none" aria-label="Page header">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <!-- Page pre-title -->
                <div class="page-pretitle">Dokumen</div>
                <h2 class="page-title">Tambah Jenis Dokumen</h2>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-xl">
        <div class="row row-cards ">
            ...
            <div class="col-sm-12 col-lg-6">
                <form class="card" method="POST" action="?page=jenis-dokumen-store" enctype="multipart/form-data">
                    <div class="card-header">
                        <h3 class="card-title">Form Tambah Jenis Dokumen</h3>
                        <div class="card-actions">
                            <a class="btn btn-outline-primary" href="?page=tambah-jenis-dokumen"><!-- Download SVG icon from http://tabler.io/icons/icon/chevron-left -->
                    ...
                    <div class="card-body">
                        <div class="mb-3 row">
                            <label class="col-3 col-form-label required">Jenis Dokumen</label>
                            <div class="col">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col">
                                ...
                                <label class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_published" id="is_published" value="0">
                    ...
                    <div class="card-table">
                        <div class="card-header">
                            <div class="row w-full">
                                <div class="col">
                                    <h3 class="card-title mb-0">Tabel Jenis Dokumen</h3>
                                    <p class="text-secondary m-0">Daftar Jenis Dokumen</p>
                                </div>
                                ...
                                <table class="table table-vcenter table-selectable table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <button class="table-sort d-flex justify-content-between" data-sort="sort-nama">Jenis Dokumen</button>
                                            </th>
                                            <th>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (status === 'success') {
                ...
                Swal.fire({
                    ...
                    cancelButtonText: 'Lihat Daftar Dokumen',
                    reverseButtons: true
                }).then((result) => {

                    if (result.isConfirmed) {
                        window.location = "?page=tambah-jenis-dokumen";
                    } else {
                        window.location = "?page=dokumen";
                    }
