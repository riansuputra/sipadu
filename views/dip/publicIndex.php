                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="dipPublikTable" class="table table-vcenter table-selectable table-bordered table-striped">
                                <thead>
                                    <tr>
                                ...
                                <tbody class="table-tbody">
                                    <?php foreach ($data as $dt => $d): ?>
                                        <tr>
                                            ...
                                            <td data-search="<?= $d['bentuk_informasi']; ?>">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const table = new DataTable('#dipPublikTable', {
            pageLength: 10,
