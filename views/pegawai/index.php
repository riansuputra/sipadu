                                ...
                                <table class="table table-vcenter table-selectable table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <button class="table-sort d-flex justify-content-between" data-sort="sort-judul">Nama</button>
                                            </th>
                                            <th>
                                                <button class="table-sort d-flex justify-content-between" data-sort="sort-jenis">NIP/NIPPPK</button>
                                            </th>
                                            <th hidden>
                                                <button class="table-sort d-flex justify-content-between" data-sort="sort-status-hid">Pangkat, GOl/Ruang</button>
                                            </th>
                                            <th class="">
                                                <button class="table-sort d-flex justify-content-between" data-sort="sort-tahun">Pangkat, GOl/Ruang</button>
                                            </th>
                                            <th class="">
                                                <button class="table-sort d-flex justify-content-between" data-sort="sort-subjek">Jabatan</button>
                                            </th>
                                            <th class="w-1">
                                                <button class="table-sort d-flex justify-content-between" data-sort="sort-status">Umur</button>
                                            </th>
                                            <th class="w-1">
                                                <button class="table-sort d-flex justify-content-between" data-sort="sort-status">Proyeksi Pensiun</button>
                                            </th>
                                            <th class="">
                                        ...
                                        <?php foreach ($data as $dt => $d): ?>
                                            <tr>
                                                ...
                                                <td class="sort-status">
                                                    ...
                                                    ?>
                                                    <span class="badge <?= $bg ?>"><?= htmlspecialchars($d['status_pensiun']) ?></span>
                                                </td>
                                                <td class="sort-file">
                                                    <?php
                                                    $listFile = [];
                                                    ...
                                                    if (!empty($d['files'])) {
                                                        ...
                                                        foreach ($files as $f) {
                                                            ...
                                                            if (count($part) >= 5) {
                                                                ...
                                                                [$id, $dokumen, $nama, $path, $tipe] = $part;

                                                                $listFile[] = [
                                                                    'dokumen' => htmlspecialchars($dokumen, ENT_QUOTES, 'UTF-8'),
                                                ...
                                                <td>
                                                    <div class="btn-group w-100">
                                                        <a href="" class="text-primary me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Detail">
