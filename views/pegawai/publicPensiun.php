                        ...
                        <div class="col-sm-12">
                            ...
                            <form method="get">
                                <div class="row">
                                    ...
                                    <input type="hidden" name="page" value="kepegawaian-pensiun">
                                    ...
                                    <div class="col-auto ms-auto">
                                        ...
                                        <a href="<?= url('?page=kepegawaian-pensiun') ?>" class="btn btn-secondary">
                    ...
                    <div class="card-body">
                        <?php if ($isFiltered): ?>
                            <div class="alert alert-info d-flex align-items-center justify-content-between" role="alert">
                                ...
                                <a href="<?= url('?page=kepegawaian-pensiun') ?>" class="btn btn-sm btn-info">
                                    Reset Filter
                                </a>
                            </div>
                        <?php else: ?>
