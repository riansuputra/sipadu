    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Edit Arsip</h2>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-xl">
        <div class="row row-cards ">
            ...
            <div class="col-sm-12 col-lg-6">
                <form class="card" method="POST" action="<?= url('?page=arsip-update&id=' . $data['id'])  ?>" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 row">
                                <div class="col">
                                    ...
                                    <input
                                        ...
                                        name="tanggal_mulai"
                                        id="tanggal_mulai"
                                        value="<?= $data['tanggal_mulai'] ?? $old['tanggal_mulai'] ?? date('Y-m-d')  ?>"
