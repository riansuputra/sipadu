    ...
    <div class="container-xl">
        ...
        <div class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            ...
            <a href="<?= BASE_URL ?>/?page=dashboard">
                <img src="http://localhost/sipadu/public/assets/img/bpmp.svg" alt="" style="height: 32px; width: auto;">
            </a>
        </div>
        <!-- END NAVBAR LOGO -->
        <div class="navbar-nav flex-row order-md-last me-2">
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 p-0 px-2" data-bs-toggle="dropdown" aria-label="Open user menu" aria-expanded="true">
                    <span class="avatar avatar-sm" style="background-image: url(http://localhost/sipadu/public/assets/img/profile.jpg)"> </span>
