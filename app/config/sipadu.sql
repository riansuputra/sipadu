...
CREATE TABLE `dip` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `kode_informasi` varchar(50) DEFAULT NULL,
  `judul_informasi` varchar(200) NOT NULL,
  `ringkasan` text,
  `jenis_informasi` enum('BERKALA','SERTA MERTA','SETIAP SAAT') NOT NULL,
...
CREATE TABLE `peraturan` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `jenis_peraturan` enum('UU','PP','PERPRES','PERMEN','PERDA','PERKADIN','SK','SE') NOT NULL,
  `nomor` varchar(50) DEFAULT NULL,
  `tahun` year(4) DEFAULT NULL,
  `judul` text NOT NULL,
  `instansi_penerbit` varchar(150) DEFAULT NULL,
  `tanggal_penetapan` date DEFAULT NULL,
