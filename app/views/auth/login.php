            ...
            <div class="col-12">
                <div class="row row-cards row-evenly">
                    ...
                    <div class="col-sm-6 col-lg-4 mt-6 p-4">
                        <h2 class="h2 text-center mb-4">Masuk ke SIPADU</h2>
                        <form action="?page=login-process" method="post" autocomplete="off" novalidate="">
                            <div class="mb-3">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="input-group input-group-flat">
                                    <input type="password" id="password" name="password" class="form-control" placeholder="Masukkan password..." autocomplete="off" requiured>
